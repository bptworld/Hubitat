...
metadata {
	definition (name: "Pollen Forecaster", namespace: "bptworld", author: "Bryan Turcotte") {
		capability "Sensor"
		capability "Polling"
	...
	preferences {
		input name: "about", type: "paragraph", element: "paragraph", title: "Pollen Forecaster", description: "Retrieve data from Pollen.com. For use with Hubitat dashboards."
