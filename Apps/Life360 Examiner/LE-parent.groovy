 ...
 *
 *
 *  V1.0.0 - 08/12/19 - Initial release.
 *
 */
...
def setVersion(){
    ...
    state.appName = "Life360ExaminerParentVersion"
    ...
    dynamicPage(name: "mainPage") {
		...
		if(state.appInstalled == 'COMPLETE'){
			section(getFormat("title", "${app.label}")) {
				paragraph "<div style='color:#1A77C9'>Simple app to log the raw data coming over from the Life360 phone app.</div>"
			...
			section(getFormat("header-green", "${getImage("Blank")}"+" Child Apps")) {
				app(name: "anyOpenApp", appName: "Life360 Examiner Child", namespace: "BPTWorld", title: "<b>Add a new 'Life360 Examiner' child</b>", multiple: true)
			}
