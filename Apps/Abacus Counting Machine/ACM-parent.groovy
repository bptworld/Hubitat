/**
 *  ****************  Abacus Counting Machine Parent ****************
 *
 *  Design Usage:
...
definition(
    ...
    iconX2Url: "",
    iconX3Url: "",
	importUrl: "https://raw.githubusercontent.com/bptworld/Hubitat/master/Apps/Abacus%20Counting%20Machine/ACM-parent.groovy"
    )
    ...
    dynamicPage(name: "mainPage") {
		...
		if(state.appInstalled == 'COMPLETE'){
			section("Instructions:", hideable: true, hidden: true) {
				...
				paragraph "Count how many times a Device is triggered. Displays Daily, Weekly, Monthly and Yearly counts!"
			}
			section(getFormat("header-green", "${getImage("Blank")}"+" Child Apps")) {
				app(name: "anyOpenApp", appName: "Abacus Counting Machine Child", namespace: "BPTWorld", title: "<b>Add a new 'Abacus Counting Machine' child</b>", multiple: true)
			}
