...
def pageConfig() {
    dynamicPage(name: "", title: "", install: true, uninstall: true) {
        ...
        section(getFormat("header-green", "${getImage("Blank")}"+" Other Options")) {
            input "goodKeywords", "text", title: "Ignore error if any of these keywords are found (seperate multiple by ; (semicolon))", required:false, submitOnChange:true
            paragraph ""
