    ...
    dynamicPage(name: "mainPage") {
		...
		if(state.appInstalled == 'COMPLETE'){
			...
			section(getFormat("header-green", "${getImage("Blank")}"+" Child Apps")) {
				app(name: "anyOpenApp", appName: "Direction Alerter Child", namespace: "BPTWorld", title: "<b>Add a new 'Direction Alerter' child</b>", multiple: true)
			}
