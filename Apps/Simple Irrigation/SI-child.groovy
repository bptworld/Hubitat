...
def pageConfig() {
    dynamicPage(name: "", title: "", install: true, uninstall: true, refreshInterval:0) {
		...
		section(getFormat("header-green", "${getImage("Blank")}"+" Notification Options")) {
			...
			input "sendSafetyPushMessage", type: "bool", title: "Send close notification even if weather switch has cancelled the schedule", defaultValue: "true", required: false
		}
