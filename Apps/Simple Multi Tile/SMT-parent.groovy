    ...
    dynamicPage(name: "mainPage") {
		...
		if(state.appInstalled == 'COMPLETE'){
			...
			section(getFormat("header-green", "${getImage("Blank")}"+" Child Apps")) {
				app(name: "anyOpenApp", appName: "Simple Multi Tile Child", namespace: "BPTWorld", title: "<b>Add a new 'Simple Multi Tile' child</b>", multiple: true)
			}
