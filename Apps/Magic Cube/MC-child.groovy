 ...
 *  1.0.3 - 08/12/19 - (aaronward) Added support for Harmony Logitech control
 *  1.0.2 - 04/15/19 - Code cleanup
 *  1.0.1 - 03/15/19 - Added Change Mode, Toggle, Dim and Set Color to device options.
 *  1.0.0 - 03/14/19 - Initial Release
 *
 */
