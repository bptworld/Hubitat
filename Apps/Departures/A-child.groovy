...
def setVersion(){
    ...
    state.appName = "DeparturesChild2Version"
...
definition(
    name: "Departures - Arrivals Child",
    namespace: "BPTWorld",
    ...
    iconX2Url: "",
    iconX3Url: "",
	importUrl: "https://raw.githubusercontent.com/bptworld/Hubitat/master/Apps/Departures/A-child.groovy",
)
...
def pageConfig() {
    dynamicPage(name: "", title: "<h2 style='color:#1A77C9;font-weight: bold'>Departures - Arrivals</h2>", install: true, uninstall: true, refreshInterval:0) {
		display() 
...
def display2(){
	...
	section() {
		paragraph getFormat("line")
		paragraph "<div style='color:#1A77C9;text-align:center'>Departures - Arrivals - @BPTWorld<br><a href='https://github.com/bptworld/Hubitat' target='_blank'>Find more apps on my Github, just click here!</a><br>Get app update notifications and more with <a href='https://github.com/bptworld/Hubitat/tree/master/Apps/App%20Watchdog' target='_blank'>App Watchdog</a><br>${state.version}</div>"
	}       
}
