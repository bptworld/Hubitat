...
metadata {
    definition (name: "Device Transformer Driver", namespace: "BPTWorld", author: "Bryan Turcotte", importUrl: "") {
        capability "Actuator"
...
preferences {
    input title:"<b>Device Transformer</b>", description:"This device was automatically created by Device Transformer<br>Note: The buttons above do not do anything.", type:"paragraph", element:"paragraph"
