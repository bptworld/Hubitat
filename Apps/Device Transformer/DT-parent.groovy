    ...
    dynamicPage(name: "mainPage") {
		...
		if(state.appInstalled == 'COMPLETE'){
			...
			section(getFormat("header-green", "${getImage("Blank")}"+" Child Apps")) {
				app(name: "anyOpenApp", appName: "Device Transformer Child", namespace: "BPTWorld", title: "<b>Add a new 'Device Transformer' child</b>", multiple: true)
			}
