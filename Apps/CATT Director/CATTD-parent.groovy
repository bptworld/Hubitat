 ...
 *
 *  This App is free.  If you like and use this app, please be sure to give a mention it on the Hubitat forums!  Thanks.
 *
 ...
 *  1.0.0 - 08/15/19 - Initial release.
 *
 */
    ...
    dynamicPage(name: "mainPage") {
		...
		if(state.appInstalled == 'COMPLETE'){
			section(getFormat("title", "${app.label}")) {
				paragraph "<div style='color:#1A77C9'>Take control of a Chromecast device using CATT.</div>"
				paragraph getFormat("line")
			}
			section("Instructions:", hideable: true, hidden: true) {
				paragraph "<b>Notes:</b>"
				paragraph "* Take control of a Chromecast device using CATT."
			}
			section(getFormat("header-green", "${getImage("Blank")}"+" Child Apps")) {
				app(name: "anyOpenApp", appName: "CATT Director Child", namespace: "BPTWorld", title: "<b>Add a new 'CATT Director' child</b>", multiple: true)
			}
