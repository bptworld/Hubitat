...
def setVersion(){
    state.name = "Ring Keypad Companion"
	state.version = "1.0.0"
}
    ...
    dynamicPage(name: "mainPage") {
		...
		if(state.appInstalled == 'COMPLETE'){
			...
			section(getFormat("header-green", "${getImage("Blank")}"+" Child Apps")) {
				app(name: "anyOpenApp", appName: "Ring Keypad Companion Child", namespace: "BPTWorld", title: "<b>Add a new 'Ring Keypad Companion' child</b>", multiple: true)
			}
