...
def notificationOptions(){
    dynamicPage(name: "notificationOptions", title: "", install: false, uninstall:false){
        ...
        section(getFormat("header-green", "${getImage("Blank")}"+" Flash Lights Options")) {
            ...
            if(useTheFlasher) {
                input "flashMyTeamScorePreset", "capability.actuator", title: "Select the Flasher Device to use when My Team scores", required:true, submitOnChange:true
                input "flashOtherTeamScorePreset", "capability.actuator", title: "Select the Flasher Device to use when the Other Team scores", required:true, submitOnChange:true
                input "flashMyTeamWinsPreset", "capability.actuator", title: "Select the Flasher Device to use when the My Team wins", required:true, submitOnChange:true
                input "flashOtherTeamWinsPreset", "capability.actuator", title: "Select the Flasher Device to use when the Other Team wins", required:true, submitOnChange:true
            }
        }
    }
}
