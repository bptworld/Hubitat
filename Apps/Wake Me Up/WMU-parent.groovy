 ...
 *  Changes:
 *
 *  1.0.0 - 07/20/20 - Initial release.
 *
 */
...
definition(
    ...
    description: "A better way to wake up. With slowly rising light levels, random announcements and more.",
    category: "Convenience",
    iconUrl: "",
    iconX2Url: "",
    iconX3Url: "",
    importUrl: "https://raw.githubusercontent.com/bptworld/Hubitat/master/Apps/Wake%20Me%20Up/WMU-parent.groovy",
)
    ...
    dynamicPage(name: "mainPage") {
		...
		if(state.appInstalled == 'COMPLETE'){
			section("Instructions:", hideable: true, hidden: true) {
				paragraph "<b>Notes:</b>"
				paragraph "A better way to wake up. With slowly rising light levels, random announcements and more."
			}
