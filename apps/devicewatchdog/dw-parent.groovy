 ...
 *
 *  Changes:
 *  All changes are listed in child app
 */
...
def colorCodingConfig() {
	dynamicPage(name: "colorCodingConfig", title: "", install:false, uninstall:false) {
        ...
        section() {
            ...
            input "colorOnline", "text", title: "Online", width: 6, defaultValue: "green"
            input "colorOffline", "text", title: "Offline", width: 6, defaultValue: "red"
...
def getImage(type) {					// Modified from @Stephack Code // library marker BPTWorld.bpt-mandatoryStuff, line 91
    ...
    if(type == "reports") return "${loc}reports.jpg height=30 width=30>" // library marker BPTWorld.bpt-mandatoryStuff, line 98
    if(type == "logo") return "${loc}logo.png height=40>" // library marker BPTWorld.bpt-mandatoryStuff, line 99
    if(type == "qmark") return "${loc}question-mark-icon.png height=16>" // library marker BPTWorld.bpt-mandatoryStuff, line 100
    if(type == "qmark2") return "${loc}question-mark-icon-2.jpg height=16>" // library marker BPTWorld.bpt-mandatoryStuff, line 101
} // library marker BPTWorld.bpt-mandatoryStuff, line 102

def getFormat(type, myText=null, page=null) {			// Modified code from @Stephack // library marker BPTWorld.bpt-mandatoryStuff, line 104
    if(type == "header-green") return "<div style='color:#ffffff;font-weight: bold;background-color:#81BC00;border: 1px solid #000000;box-shadow: 2px 3px #80BC00;border-radius: 10px'>${myText}</div>" // library marker BPTWorld.bpt-mandatoryStuff, line 105
    if(type == "line") return "<hr style='background-color:#1A77C9; height: 1px; border: 0;' />" // library marker BPTWorld.bpt-mandatoryStuff, line 106
    if(type == "title") return "<h2 style='color:#1A77C9;font-weight: bold'>${myText}</h2>" // library marker BPTWorld.bpt-mandatoryStuff, line 107

    if(type == "button-blue") return "<a style='color:white;text-align:center;font-size:20px;font-weight:bold;background-color:#03FDE5;border:1px solid #000000;box-shadow:3px 4px #8B8F8F;border-radius:10px' href='${page}'>${myText}</a>" // library marker BPTWorld.bpt-mandatoryStuff, line 109
} // library marker BPTWorld.bpt-mandatoryStuff, line 110

def display(data) { // library marker BPTWorld.bpt-mandatoryStuff, line 112
    if(data == null) data = "" // library marker BPTWorld.bpt-mandatoryStuff, line 113
    if(app.label) { // library marker BPTWorld.bpt-mandatoryStuff, line 114
        if(app.label.contains("(Paused)")) { // library marker BPTWorld.bpt-mandatoryStuff, line 115
            theName = app.label - " <span style='color:red'>(Paused)</span>" // library marker BPTWorld.bpt-mandatoryStuff, line 116
        } else { // library marker BPTWorld.bpt-mandatoryStuff, line 117
            theName = app.label // library marker BPTWorld.bpt-mandatoryStuff, line 118
        } // library marker BPTWorld.bpt-mandatoryStuff, line 119
    } // library marker BPTWorld.bpt-mandatoryStuff, line 120
    if(theName == null || theName == "") theName = "New Child App" // library marker BPTWorld.bpt-mandatoryStuff, line 121
    if(!state.name) { state.name = "" } // library marker BPTWorld.bpt-mandatoryStuff, line 122
    if(state.name == theName) { // library marker BPTWorld.bpt-mandatoryStuff, line 123
        headerName = state.name // library marker BPTWorld.bpt-mandatoryStuff, line 124
    } else { // library marker BPTWorld.bpt-mandatoryStuff, line 125
        if(state.name == null || state.name == "") { // library marker BPTWorld.bpt-mandatoryStuff, line 126
            headerName = "${theName}" // library marker BPTWorld.bpt-mandatoryStuff, line 127
        } else { // library marker BPTWorld.bpt-mandatoryStuff, line 128
            headerName = "${state.name} - ${theName}" // library marker BPTWorld.bpt-mandatoryStuff, line 129
        } // library marker BPTWorld.bpt-mandatoryStuff, line 130
    } // library marker BPTWorld.bpt-mandatoryStuff, line 131
    section() { // library marker BPTWorld.bpt-mandatoryStuff, line 132
        paragraph "<h2 style='color:#1A77C9;font-weight: bold'>${headerName}</h2><div style='color:#1A77C9'>A BPTWorld App</div>" // library marker BPTWorld.bpt-mandatoryStuff, line 133

        //<a href='https://community.hubitat.com/t/release-bundle-manager-the-only-place-to-find-bptworld-bundles-find-install-and-update-bundles-quickly-and-easily/94567/295' target='_blank'>Bundle Manager</a>! // library marker BPTWorld.bpt-mandatoryStuff, line 135

        paragraph getFormat("line") // library marker BPTWorld.bpt-mandatoryStuff, line 137
    } // library marker BPTWorld.bpt-mandatoryStuff, line 138
} // library marker BPTWorld.bpt-mandatoryStuff, line 139

def display2() { // library marker BPTWorld.bpt-mandatoryStuff, line 141
    setVersion() // library marker BPTWorld.bpt-mandatoryStuff, line 142
    section() { // library marker BPTWorld.bpt-mandatoryStuff, line 143
        if(state.appType == "parent") { href "removePage", title:"${getImage("optionsRed")} <b>Remove App and all child apps</b>", description:"" } // library marker BPTWorld.bpt-mandatoryStuff, line 144
        paragraph getFormat("line") // library marker BPTWorld.bpt-mandatoryStuff, line 145
        if(state.version) { // library marker BPTWorld.bpt-mandatoryStuff, line 146
            bMes = "<div style='color:#1A77C9;text-align:center;font-size:20px;font-weight:bold'>${state.name} - ${state.version}" // library marker BPTWorld.bpt-mandatoryStuff, line 147
        } else { // library marker BPTWorld.bpt-mandatoryStuff, line 148
            bMes = "<div style='color:#1A77C9;text-align:center;font-size:20px;font-weight:bold'>${state.name}" // library marker BPTWorld.bpt-mandatoryStuff, line 149
        } // library marker BPTWorld.bpt-mandatoryStuff, line 150
        bMes += "</div>" // library marker BPTWorld.bpt-mandatoryStuff, line 151
        paragraph "${bMes}" // library marker BPTWorld.bpt-mandatoryStuff, line 152
        paragraph "<div style='color:#1A77C9;text-align:center'>BPTWorld<br>Donations are never necessary but always appreciated!<br><a href='https://paypal.me/bptworld' target='_blank'><img src='https://raw.githubusercontent.com/bptworld/Hubitat/master/resources/images/pp.png'></a></div>" // library marker BPTWorld.bpt-mandatoryStuff, line 153
    } // library marker BPTWorld.bpt-mandatoryStuff, line 154
} // library marker BPTWorld.bpt-mandatoryStuff, line 155
