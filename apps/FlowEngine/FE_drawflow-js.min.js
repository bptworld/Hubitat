    ...
    return function(e) {
        ...
        class i {
            ...
            drawConnection(e) {
                ...
                // >>> These lines must come AFTER variable assignment <<<
                var i = e.parentElement.parentElement.id.slice(5),
                    s = e.classList[1];
                t.setAttribute("data-from", i);
                t.setAttribute("data-to", s);
                ...
                if (s === this.getModuleFromNodeId(t)) {
                    ...
                    if (!1 === l) {
                        if (this.drawflow.drawflow[s].data[e].outputs[n].connections.push({
                            ...
                            a.setAttribute("data-from",e),
                            a.setAttribute("data-to",t),
                            a.classList.add("node_in_node-" + t),
                            a.classList.add("node_out_node-" + e),
                            a.classList.add(n), a.classList.add(i),
                            a.appendChild(r), this.precanvas.appendChild(a),
