...
#   Version : 1.7   Customized for Hubitat - https://github.com/bdwilson/hubitat/tree/master/BTLE-Presence
#
# Feature : 
...
URL_HUBITAT = 'http://192.168.86.81/apps/api/1788/location/?user=PARAM_NAME&location=PARAM_IDX&cmd=PARAM_CMD&access_token=4fae6f24-aeeddca0'
...
# location/name of where this app is running from - home, garage, etc.``
# mode : SWITCH_MODE = One update per status change / REPEAT_MODE = continuous # updating the RSSI every 3 seconds

TAG_DATA = [
            ["TestBeacon","dd:33:0a:11:18:1d",30,0,"BTLE",REPEAT_MODE],
...
logOutFilename='check_beacon_presence.log'       # output LOG : File or console (comment this line to console output)
